...
function superbowlWin(record) {
  const positiveResult = record.find((record) => record.result === "W");
  const negativeResult = record.find((record) => record.result !== "W");
  if (positiveResult) return positiveResult.year;
  else if (negativeResult) return undefined;
}
